...
export function checkPhoneNumber(number) {
  // console.log(number);
  return /\(\+[0-9][0-9]\)\s[0-9][0-9][0-9]-[0-9][0-9][0-9]-[0-9][0-9][0-9]/.test(number) ? "Thanks! You can now download me to your phone." : `Oops, it seems like I can't reach out to ${number}`;
}
