 ...
 */
export function fixListOfWagons([tailOne, tailTwo, ...restIds]) {
  return [...restIds, tailOne, tailTwo];
}
 ...
 */
export function correctListOfWagons([loco, ...restIds], missingWagons) {
  return [loco, ...missingWagons, ...restIds];
}
 ...
 */
export function separateTimeOfArrival({timeOfArrival: time, ...restInfo}) {
  return [time, restInfo];
}
